...
def _result_payload(
    *,
    ...
    return {
        "schema_version": "mke.retrieval_order_compatibility_result.v1",
        "command": command,
        "status": status,
...
def _failed_result(
    *,
    ...
    return _result_payload(
        ...
        problem=problem,
        cause="compatibility_authority_not_established",
        next_step="retain_evidence_and_stop",
    )
    ...
    *,
    ...
    if destination == (root / _CANONICAL_ARTIFACT).resolve():
        return _failed_result(
            command="record",
            problem="retrieval_order_canonical_path_forbidden",
        )
    try:
        ...
        return _failed_result(
            command="record",
            problem="retrieval_order_compatibility_failed",
        )
...
def validate_temporary_compatibility(
    *,
    ...
    try:
        ...
        return _failed_result(
            command="validate",
            problem="retrieval_order_compatibility_invalid",
        )
    return _result_payload(
        command="validate",
        status="passed",
